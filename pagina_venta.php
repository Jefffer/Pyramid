                          ...
                          <div class="programa-evento">
                             ...
                             <div id="talleres" class="info-curso ocultar clearfix">
                                <div class="detalle-evento items_detalle">
                                     ...
                                     <p><i class="fas fa-hand-holding-usd" aria-hidden="true"></i> <span class="ttl_info">Valor venta:</span> <b> $'.$result['precio_inmueble'].'</b></p>
                                     <p><i class="fas fa-dollar-sign" aria-hidden="true"></i> <span class="ttl_info">Administración:</span> <b> $'.$result['admon_inmueble'].'</b></p>
                                     <p><i class="fas fa-barcode" aria-hidden="true"></i> <span class="ttl_info">Código:</span> '.$result['pk_inmueble'].'-V</p>
