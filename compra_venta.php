...
<html class="no-js" lang="">
    <head>
        ...
        <title>Compra y Venta .: Viata Inmobiliaria</title>
    ...
    <body class="conferencia">
        ...
        <section id="compra_venta" class="seccion contenedor padding_bot_0 top_-180">
           ...
           <p>
             En <b>V<span class="rojito">î</span>ata Inmobiliaria</b>  nos encargamos de publicar tu inmueble, incluyendo un servicio gratuito de galería fotográfica profesional y un video recorriendo los distintos espacios que componen la vivienda. Para más información haz click <a class="estilos_links" href="#vende-nosotros"> aquí</a>.
            </p>
            <p>
...
<?php
  ...
  if (isset($_POST['submitForm'])) {
    ...
    $to = $_POST['emailForm'];
    $subject = "Vende con Nosotros .: Viata Inmobiliaria";
    ...
    try {
      ...
      try {
        ...
        echo "alert('Registro exitoso. Nos pondremos en contacto contigo muy pronto ". $_POST['schedule'] ."');";
        echo "</script>";
      }
      catch(PDOException $e)
      {
